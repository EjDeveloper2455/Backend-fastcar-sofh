...
BEGIN
    ...
    e.empleado_dni as DNI, e.empleado_nombre as nombre,
...
-- Dumping structure for table bd_ej_soft.tbl_cargo
CREATE TABLE IF NOT EXISTS `tbl_cargo` (
  `cargo_id` int NOT NULL AUTO_INCREMENT,
  `cargo_nombre` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cargo_date_create` datetime DEFAULT CURRENT_TIMESTAMP,
  `cargo_date_update` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `cargo_estado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT 'Activo',
  PRIMARY KEY (`cargo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table bd_ej_soft.tbl_cargo: ~5 rows (approximately)
REPLACE INTO `tbl_cargo` (`cargo_id`, `cargo_nombre`, `cargo_date_create`, `cargo_date_update`, `cargo_estado`) VALUES
	(1, 'Administrador', '2023-07-29 11:22:48', '2023-07-29 11:22:48', 'Activo'),
	(2, 'Gerente de sucursal', '2023-07-29 11:23:41', '2023-07-29 11:23:41', 'Activo'),
	(3, 'Control de vehiculos', '2023-07-29 11:23:41', '2023-07-29 11:23:41', 'Activo'),
	(4, 'Control de seguro', '2023-07-29 11:23:41', '2023-07-29 11:23:41', 'Activo'),
	(5, 'Control de reservacion', '2023-07-29 11:23:41', '2023-07-29 11:23:41', 'Activo'),
	(6, 'Reclutador', '2023-07-29 17:19:24', '2023-07-29 17:19:24', 'Activo');
...
-- Dumping structure for table bd_ej_soft.tbl_departamento
CREATE TABLE IF NOT EXISTS `tbl_departamento` (
  `departamento_id` int NOT NULL AUTO_INCREMENT,
  `departamento_nombre` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `departamento_date_create` datetime DEFAULT CURRENT_TIMESTAMP,
  `departamento_date_update` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `departamento_estado` varchar(45) COLLATE utf8mb4_general_ci DEFAULT 'Activo',
  PRIMARY KEY (`departamento_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table bd_ej_soft.tbl_departamento: ~5 rows (approximately)
REPLACE INTO `tbl_departamento` (`departamento_id`, `departamento_nombre`, `departamento_date_create`, `departamento_date_update`, `departamento_estado`) VALUES
	(1, 'Administracion', '2023-07-29 11:24:29', '2023-07-29 11:24:29', 'Activo'),
	(2, 'Gerencia', '2023-07-29 11:24:29', '2023-07-29 11:24:29', 'Activo'),
	(3, 'Vehiculos', '2023-07-29 11:24:29', '2023-07-29 11:24:29', 'Activo'),
	(4, 'Seguros', '2023-07-29 11:24:29', '2023-07-29 11:24:29', 'Activo'),
	(5, 'Reservaciones', '2023-07-29 11:24:29', '2023-07-29 11:24:29', 'Activo'),
	(6, 'Recursos Humanos', '2023-07-29 17:19:42', '2023-07-29 17:19:42', 'Activo');
...
CREATE TABLE IF NOT EXISTS `tbl_empleado` (
  ...
  `empleado_url_foto` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `empleado_fecha_nacimiento` datetime DEFAULT NULL,
  `empleado_direccion` text COLLATE utf8mb4_general_ci,
  `empleado_telefono` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `empleado_correo` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping data for table bd_ej_soft.tbl_empleado: 2 rows
/*!40000 ALTER TABLE `tbl_empleado` DISABLE KEYS */;
REPLACE INTO `tbl_empleado` (`empleado_dni`, `empleado_nombre`, `sucursal_id`, `empleado_sexo`, `cargo_id`, `departamento_id`, `empleado_url_foto`, `empleado_fecha_nacimiento`, `empleado_direccion`, `empleado_telefono`, `empleado_correo`, `empleado_create_date`, `empleado_update_date`, `empleado_estado`) VALUES
	('0413199700796', 'ELMER JOHEL MEJIA LEIVA', 5, 'MASCULINO', 1, 1, 'default.png', NULL, NULL, NULL, NULL, '2023-05-22 20:18:41', '2023-07-29 17:29:34', 'Activo'),
	('0101200500123', 'FERNANDO DAVID MEJIA LEIVA', 4, 'MASCULINO', 2, 2, 'https://storage.googleapis.com/project-ej-1471f.appspot.com/imagenes/empleados/1690682757835_0101200500123.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..mqP7nYY0eve77BwpAvBwK4CWD2dVfM1HASmGGoYO2E0', '2005-07-29 00:00:00', 'Bo. La Isla, La Ceiba, Atlántida.', '(+504) 8896-1235', 'fernandom55@gmail.com', '2023-07-29 20:05:57', '2023-07-29 20:05:59', 'Activo');
...
-- Dumping data for table bd_ej_soft.tbl_empleado_usuario: ~2 rows (approximately)
REPLACE INTO `tbl_empleado_usuario` (`id`, `usuario_email`, `empleado_dni`) VALUES
	(1, 'Elmer', '0413199700796'),
	(2, 'rhadmin', '0101200500123');
...
-- Dumping data for table bd_ej_soft.tbl_usuario: 3 rows
...
REPLACE INTO `tbl_usuario` (`usuario_email`, `usuario_password`, `usuario_rol`, `usuario_create_date`, `usuario_update_date`, `usuario_estado`) VALUES
	...
	('rhadmin', '$2a$10$cVVXgsnH44ZA5kN7V9xg1eAZ41gnx2PwLYNMljsW4hEWLeR8qBXM.', 'Gerente de sucursal', '2023-07-29 20:05:59', '2023-07-29 20:05:59', 'Activo');
